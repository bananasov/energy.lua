...
local industrial_solar_panel = {
    name = "techreborn:industrial_solar_panel"
}

---@return number
function industrial_solar_panel:get_total_stored()
...
---@return number
function industrial_solar_panel:get_total_capacity()
    local peripherals = util.get_peripherals_from_type(self.name)
